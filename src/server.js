...
import senateRoutes from './routes/senate.js';
...
import v1PaymentsRoutes from './routes/v1/payments.js';
import apiPaymentsRoutes from './routes/apiPayments.js';
...
await fastify.register(senateRoutes, { prefix: '/api/v1/senate' });
...
await fastify.register(v1PaymentsRoutes, { prefix: '/api/v1/payments' });
await fastify.register(apiPaymentsRoutes, { prefix: '/api/payments' });
