...
export const REGIONAL_CONFIG = {
  ...
  EGP: {
    ...
    prestige: {
      royal_vanguard: { price: 500, label: 'E£ 500' },
      red_devils_elite: { price: 500, label: 'E£ 500' }
    }
  },
  TZS: {
    currency: 'TZS',
  ...
  TND: {
    ...
    packs: {
      impulse: { price: 5, label: '5 DT' },
      warrior: { price: 20, label: '20 DT' },
      tribe_leader: { price: 50, label: '50 DT' },
    },
    prestige: {
      tournament_entry: { price: 2, label: '2 DT' },
      badge_unlock: { price: 10, label: '10 DT' },
      tcl_blood_gold: { price: 30, label: '30 DT' },
      blood_and_gold: { price: 30, label: '30 DT' },
      red_and_white: { price: 30, label: '30 DT' }
    }
  },
